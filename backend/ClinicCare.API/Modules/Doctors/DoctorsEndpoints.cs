using MediatR;
using ClinicCare.Application.Features.Doctors.Queries.GetDoctors;
using ClinicCare.Application.Features.Doctors.Queries.GetDoctorAvailability;
using ClinicCare.Application.Features.Doctors.Commands.CreateDoctorAvailability;
using ClinicCare.Application.Features.Doctors.Commands.UpdateDoctorAvailability;
using ClinicCare.Application.Features.Doctors.Commands.DeleteDoctorAvailability;
using ClinicCare.Application.Common.Models;

namespace ClinicCare.API.Modules.Doctors;
