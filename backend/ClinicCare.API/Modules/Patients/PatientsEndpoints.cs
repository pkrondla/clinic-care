using ClinicCare.Application.Features.Patients.Commands.CreatePatient;
using ClinicCare.Application.Features.Patients.Commands.DeletePatient;
using ClinicCare.Application.Features.Patients.Commands.UpdatePatient;
using ClinicCare.Application.Features.Patients.Queries.GetPatient;
using ClinicCare.Application.Features.Patients.Queries.GetPatients;
using ClinicCare.Application.Features.Patients.Queries.SearchPatients;
using MediatR;
using Microsoft.AspNetCore.Authorization;

namespace ClinicCare.API.Modules.Patients;
