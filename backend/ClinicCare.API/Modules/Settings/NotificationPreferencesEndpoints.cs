using ClinicCare.Application.Features.Notifications.Commands.UpdateNotificationPreferences;
using ClinicCare.Application.Features.Notifications.Queries.GetNotificationPreferences;
using MediatR;
...
public static class NotificationPreferencesEndpoints
{
    public static IEndpointRouteBuilder MapNotificationPreferencesEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapGet("/", GetNotificationPreferences)
            ...
            .Produces<List<NotificationPreferenceDto>>(StatusCodes.Status200OK);
