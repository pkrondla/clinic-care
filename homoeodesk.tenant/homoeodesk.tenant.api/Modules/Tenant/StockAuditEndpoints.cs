using HomoeoDesk.Tenant.Application.Features.Inventory.Commands.PerformStockAudit;
using HomoeoDesk.Tenant.Application.Features.Inventory.Queries.GetStockAuditHistory;
