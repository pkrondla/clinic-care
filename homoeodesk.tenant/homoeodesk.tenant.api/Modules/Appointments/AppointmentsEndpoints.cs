...
using HomoeoDesk.Tenant.Application.Features.Appointments.Commands.CancelAppointment;
...
using HomoeoDesk.Tenant.Application.Features.Appointments.Queries.GetQueue;
using HomoeoDesk.Tenant.Application.Features.Appointments.Commands.BookAppointment;
using HomoeoDesk.Tenant.Application.Features.Appointments.Commands.StartAppointment;
using HomoeoDesk.Tenant.Application.Features.Appointments.Commands.CompleteAppointment;
...
public static class AppointmentsEndpoints
{
    ...
    private static async Task<IResult> GetAppointments(
        ...
        CancellationToken cancellationToken)
    {
        var query = new GetAppointmentsQuery(BranchId, doctorId, date, status);
