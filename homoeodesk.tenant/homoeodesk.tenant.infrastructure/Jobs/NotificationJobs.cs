...
namespace HomoeoDesk.Tenant.Infrastructure.Jobs;
...
public class NotificationJobs
{
    ...
    /// <summary>
    /// Lightweight maintenance job (Hangfire tenant-maintenance queue).
    /// </summary>
    public Task RunDatabaseMaintenanceAsync(CancellationToken cancellationToken = default)
    {
        _logger.LogInformation("Tenant database maintenance job completed at {Time}", DateTime.UtcNow);
