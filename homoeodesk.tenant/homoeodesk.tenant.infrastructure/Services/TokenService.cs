...
public class TokenService : ITokenService
{
    ...
    public async Task<(string accessToken, string refreshToken, DateTime expiresAt)> GenerateTokensAsync(User user, int? selectedBranchId = null)
    {
        ...
        {
            claims.Add(new("BranchId", selectedBranchId.Value.ToString()));
        }
    ...
    public string GenerateAccessToken(User user)
    {
        ...
        {
            claims.Add(new("BranchId", user.SelectedBranchId.Value.ToString()));
        }
