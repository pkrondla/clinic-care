...
export const PurchaseOrderFormPage = () => {
  ...
  const handleClinicChange = async (BranchId: number) => {
    try {
      const inventory = await inventoryService.getAll(BranchId)
                ...
                <Col xs={24} sm={12}>
                  ...
                  >
                    <Select
                      ...
                      options={Branches.map(c => ({ label: c.name, value: c.id }))}
                    />
                  </Form.Item>
                </Col>
                <Col xs={24} sm={12}>
          ...
          <Card
            ...
            extra={
              <Button
                ...
                disabled={!form.getFieldValue('BranchId')}
              >
                Add Item
              </Button>
            }
