...
import { useSelectedBranch, useAuth } from '@core/stores/authStore'
import { useNavigate } from 'react-router-dom'
import dayjs from 'dayjs'
import type { Clinic } from '@core/services/branchService'
...
export const BookAppointmentPage = () => {
  ...
  const SelectedBranchId = Form.useWatch('BranchId', form) || selectedClinic?.id
    ...
    <div style={{ maxWidth: 700, margin: '0 auto', padding: '24px' }}>
      <Card>
        ...
        >
          ...
          >
            <Select 
              placeholder={SelectedBranchId ? "Select doctor" : "Please select a clinic first"}
              disabled={!SelectedBranchId || doctorsLoading}
