...
export const InventoryReportPage = () => {
  ...
  const clinicInventoryColumns = [
    ...
    },
    {
      ...
      key: 'totalValue',
      render: (value: number) => `₹${value.toFixed(2)}`,
      sorter: (a: BranchInventoryDto, b: BranchInventoryDto) => 
        a.totalValue - b.totalValue,
    },
    {
      title: 'Low Stock',
        ...
        <div>
          ...
          <Card title="Inventory by Clinic">
            <Table
              ...
              pagination={false}
              expandable={{
                expandedRowRender: (record: BranchInventoryDto) => (
                  <Table
                    columns={[
                      ...
                      { 
                        title: 'Available', 
                        key: 'available',
                        render: (_: any, stock: BranchStockDto) => `${stock.availableQuantity} ${stock.unitPrice > 0 ? 'units' : ''}`,
                      },
            ...
            expandedRowRender: (record: CombinedInventoryItemDto) => (
              <div style={{ padding: '16px' }}>
                ...
                <Table
                  ...
                  dataSource={record.Branchestocks}
                  rowKey="BranchId"
                  pagination={false}
                  size="small"
                />
        ...
        <div>
          {report && report.lowStockAlerts.length > 0 ? (
            <Table
              ...
              rowKey={(record, index) => `${record.BranchId}-${record.medicineId}-${index}`}
              loading={isLoading}
              pagination={{ pageSize: 20 }}
            />
          ) : (
