...
namespace HomoeoDesk.Tenant.Application.Features.Reports.Queries.GetCollectionReport;
...
{
    public string GroupKey { get; set; } = string.Empty; // Date, Branch Name, Doctor Name, etc.
