...
namespace HomoeoDesk.Tenant.Application.Features.Invoices.Commands.CreateInvoiceFromPrescription;
    ...
    public async Task<Result<InvoiceDto>> Handle(CreateInvoiceFromPrescriptionCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            var dto = new InvoiceDto
            {
                ...
                BranchId = invoiceWithDetails.BranchId,
                BranchName = invoiceWithDetails.Branch?.Name ?? "Unknown",
