...
public class NotificationPreferencesReadService : INotificationPreferencesReadService
{
    private readonly IApplicationDbContext _context;

    public NotificationPreferencesReadService(IApplicationDbContext context)
    {
        _context = context;
    }
    ...
    private static string GetNotificationTypeName(NotificationType type)
    {
        return type switch
        {
