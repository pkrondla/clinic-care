...
export const clinicMedicineKeys = {
  ...
  list: (params?: { searchTerm?: string; clinicId?: number; isActive?: boolean }) => [...clinicMedicineKeys.lists(), params] as const,
...
export const useClinicMedicines = (params?: { searchTerm?: string; clinicId?: number; isActive?: boolean }) => {
  return useQuery({
